...
from Data_Plotting_20260510 import *
...
Group = "X" # 'X' for species, 'Genus' for genus, or 'Family' for family
GroupLabel = "Species" # 'Species' for species, 'Genus' for genus, or 'Family' for family
